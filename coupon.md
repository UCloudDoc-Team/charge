...
| 代金券金额处理方式 | 对应场景说明 |
|---|---|
| 全额退还    | 使用代金券购买资源时，如果遇到支付失败或发货失败的情况，代金券将全额退还。 |
| 不予退还    | 1. 使用代金券支付成功，不支持退还。<br>2. 用户资源被删除后，使用代金券抵扣的金额不支持退还。<br>3. 一张代金券仅可用于抵扣一个资源单次购买或续费时的费用，若订单实际费用低于代金券面额，该代金券未使用的剩余金额不予退还。 |
